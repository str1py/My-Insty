...
namespace Instagram_Assistant.Model
{
    class AudienceActionModel : ActionModel
    {
        ...
        public void AccountTypeConvert(int type)
        {
            if (type == 1)
            {
        ...
        public void FollowersCountConvert(int count)
        {
        ...
        public void MediaCountConvert(int count)
        {
            MediaCount = count;
            if (count < 15)
        ...
        public void AccountCategotyConvert(string category)
        {
        ...
        public void HasBioConvert(string bio)
        {
        ...
        public void HasHighlightConvert(bool hl) 
        {
            if (hl)
            {
                HasHighlight = "Yes";
        ...
        public void HasImageConvert(string image)
        {
            if (image!=null || image != "")
            {
                HasImage = "Yes";
        ...
        public void HasStopWordConvert(bool stopword) 
        {
            if (stopword)
            {
                HasStopWord = "Yes";
        ...
        public void HasGoWordConvert(bool goword)
        {
            if (goword)
            {
                HasGoWord = "Yes";
        ...
        public void CityConvert(bool iscity,string city)
        {
            IsCity = iscity;
        ...
        public void ActionConvert(string act)
        {
            if (act == "UserTimes")
            {
                Action = "UserTimes";
        ...
        public string RemoveSimbols(string str)
        {
